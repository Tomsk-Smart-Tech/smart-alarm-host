            ...
            Rectangle {
                ...
                Column {
                    ...
                    Text {
                        ...
                        height: 32
                        color: Themes.textColorSecond
                        text: qsTr("Норма загрязнения в комнате: 0-200")
                        font.pixelSize: 20
                        horizontalAlignment: Text.AlignRight
                        wrapMode: Text.WordWrap
                        font.family: castFont.name
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            height: 35
                            color: {
                                if (parseInt(sensorsPopup.voc_index) >= 0 && parseInt(sensorsPopup.voc_index) <= 200){
                                    "#82ff66"
                                } else if(parseInt(sensorsPopup.voc_index) > 200){
                                    "#ff3f3f"
                                } else {
                                    "#ff3f3f"
                                }
